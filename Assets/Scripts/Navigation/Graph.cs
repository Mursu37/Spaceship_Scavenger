...
namespace Octrees
{
    public class Node
    {
        ...
        public List<Edge> edges = new(); // List of edges of the node
    ...
    public class Edge
    {
        ...
        // Checks if the object is edge and the nodes match
    ...
    public class Graph
    {
        ...
        public OctreeNode GetPathNode(int index)
        {
            ...
            {
                UnityEngine.Debug.LogError($"Index ot of bounds. Path length: {pathList.Count}, Index: {index}");
                return null;
            }
        ...
        public bool AStar(OctreeNode startNode, OctreeNode endNode)
        {
            ...
            if (start == null)
            {
                UnityEngine.Debug.LogError("Start node not found in the graph.");
                return false;
            }
            else if (end == null)
            {
                UnityEngine.Debug.LogError("End node not found in the graph.");
                return false;
            }
            ...
            while (openSet.Count > 0)
            {
                ...
                {
                    UnityEngine.Debug.LogError("A* exceeded maximum iterations.");
                    return false;
                }
