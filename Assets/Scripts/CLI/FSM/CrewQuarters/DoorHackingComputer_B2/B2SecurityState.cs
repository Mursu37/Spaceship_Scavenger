...
namespace CLI.FSM
{
    public class B2SecurityState : State
    {
        ...
        {
            directories.Add("access", new B2DoorControlState(controller));
        ...
        public override void Interpret(string command)
        {
            ...
            if (command == "log")
            {
                stateController.ChangeText("[DOOR USAGE LOG: STORAGE SPACE]\r\n" +
                    "- 16:02 SHIPTIME: Officer Greer entered.\r\n" +
                    "- 16:04 SHIPTIME: Motion detected; system locked door.\r\n" +
                    "- 16:06 SHIPTIME: Override attempt failed(log corrupted).  ");
            }
