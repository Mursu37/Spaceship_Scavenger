...
namespace CLI.FSM
{
    public class A1SecurityState : State
    {
        private bool query = false;

        public A1SecurityState(StateController controller) : base(controller)
        {
            directories.Add("access", new A1DoorControlState(controller));
        ...
        public override void Interpret(string command)
        {
            ...
            if (command == "log")
            {
                stateController.ChangeText("[DOOR USAGE LOG: CREW LOUNGE]\r\n" +
                    "- 20:05 SHIPTIME: Crew Member Tess entered.\r\n" +
                    "- 20:10 SHIPTIME: Door sealed due to environmental hazard.\r\n" +
                    "- 20:13 SHIPTIME: Ventilation system override activated.");
            }
